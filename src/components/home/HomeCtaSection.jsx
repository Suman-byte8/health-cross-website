        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#e5f3ef] via-white to-[#fff8e1] border border-gray-200 p-8 text-center lg:p-10">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-[#0d7055] px-7 py-3.5 text-sm font-semibold text-white hover:bg-[#0a5243] transition"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-lg bg-[#25D366] px-7 py-3.5 text-sm font-semibold text-white hover:bg-[#1eb855] transition"
            >
              <MessageCircle className="h-4 w-4" /> WhatsApp Us
            </a>
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 rounded-lg border border-[#0d7055]/15 bg-white px-7 py-3.5 text-sm font-semibold text-[#1a1a1a] hover:bg-[#0d7055]/5 transition"
            >
